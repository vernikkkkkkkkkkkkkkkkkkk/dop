...
// 1.	Система может предложить замену одного продукта на другой.
//    При выдачи списка рецептов, сначала отображаются те рецепты,
//    для которых есть все продукты, затем рецепты, где можно сделать замену.

void use_case_1(const Fridge &fridge, const Products &products, const std::string& selected_prod,
...
void
show_use_case_1(const std::vector<std::string>& skip_recipes,
